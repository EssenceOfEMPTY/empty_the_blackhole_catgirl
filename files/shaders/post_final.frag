...
void main( )
{
 const float HDNOITA_ZOOM = 1.5;
 const float SCREEN_W = 640.0;
 const float SCREEN_H = 363.0;
 ...
 const float DISTORTION_TIME_SPD 		= 10.0 / HDNOITA_ZOOM;
 const float DISTORTION_SCALE_MULT 		= 50.0 * HDNOITA_ZOOM;
...
// liquid distortion/refraction effect ( calculate distorted texture coordinates for later use ) ===============
 ...
 const float SHADING_BRIGHT_BITS_ALPHA = 0.25 * HDNOITA_ZOOM;
 ...
 {
 float distortion_mult = time * DISTORTION_TIME_SPD / HDNOITA_ZOOM; // time * ( DISTORTION_TIME_SPD - 5.0 *drugged_distortion_amount );
...
// overlay ====================================================================================================
 ...
 color.rgb = mix( color, overlay_color_blindness.rgb, overlay_color_blindness.a * 0.5 + overlay_color_blindness.a * edge_dist*edge_dist * 40.0 * HDNOITA_ZOOM * HDNOITA_ZOOM );
